...
<html>
	...
	<body>
		...
		<div class="form-group">
			...
			<input id="exampleInputEmail1" class="form-control" type="text" placeholder=""   name="title">
		</div>
		<div class="form-group">
			<label for="exampleInputEmail1">作者</label>
			<input id="exampleInputEmail1" class="form-control" type="text" placeholder=""   name="author">
		</div>
		<div class="form-group">
		...
		<div id="">
			...
			<br />
			<?php foreach ($tagData as $k=>$va){?>
			<label class="checkbox checkbox-inline" for="checkbox<?php echo $k?>">
				<input id="checkbox<?php echo $k?>" class="custom-checkbox"  type="checkbox" data-toggle="checkbox" value="<?php echo $va['tid']?>"  name="tid[]">
				<span class="icons">
