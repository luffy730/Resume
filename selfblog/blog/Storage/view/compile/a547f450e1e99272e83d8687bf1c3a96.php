...
<html>
	...
	<body>
		...
		<div class="form-group">
			...
			<input id="exampleInputEmail1" class="form-control" type="text" placeholder="请输入分类名称" required="" name="cname" value="<?php echo $oldData['cname']?>">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<textarea name="ctitle" rows="5" cols=""  class="form-control" placeholder="请输入分类关键字"><?php echo $oldData['ctitle']?></textarea>
		</div>
		<div class="form-group">
