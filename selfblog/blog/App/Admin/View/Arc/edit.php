...
<html>
	...
	<body>
		...
		<div class="form-group">
			...
			<input id="exampleInputEmail1" class="form-control" type="text"    name="title" value="{{$oldData['title']}}">
		</div>
		<div class="form-group">
			<label for="exampleInputEmail1">作者</label>
			<input id="exampleInputEmail1" class="form-control" type="text" placeholder=""   name="author" value="{{$oldData['author']}}">
		</div>
		<div class="form-group">
			...
			<select name="category_cid" class="form-control">
				...
				<option value="{{$v['cid']}}" {{if value="$oldData['category_cid'] eq $v['cid']"}} selected {{endif}}>{{$v['_name']}}</option>
				{{endforeach}}
			</select>
		</div>
		<div class="form-group">
		...
		{{if value="$oldData['thumb']"}}
				<img src="{{$oldData['thumb']}}" style="width: 250px;height: auto;" id="img"/>
