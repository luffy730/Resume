			...
			<div class="top">
				...
				<ul class="zc-quick-menu">
					...
					<li class="zc-my-center">
						<a href="{{U('MyOrder/center')}}" class="zc-hd">
							买家中心
							<i class="ico"></i>
						</a>
		...
		<div style="background:url(./Public/Home/images/images//1.jpg) top center scroll no-repeat;">
			...
			<div class="nav-box">
				<div class="category-nav-container">
					...
					<div class="category-menu-nav">
						<ul class="menu-nav-container">
							{{foreach from="$newCats" value="$v"}}
							<li>
								<div class="item">
									<!--<i class="iconfont"></i>-->
									{{foreach from="$v['_data']" value="$va"}}
									<a href="{{U('List/index',array('cid'=>$va['cid']))}}" target="_blank">{{$va['cname']}}</a>
									{{endforeach}}
								</div>
								<div class="catCon category-1" style="display: none;">
                                        <dl class="service">
                                        	...
                                        	{{foreach from="$v['_data']" value="$ve"}}
                                        <dl>
                                                <dt>
                                                	<a href="{{U('List/index',array('cid'=>$ve['cid']))}}" target="_blank">
                                                		{{$ve['cname']}}
                                                	</a>
                                                ...
                                                <dd> 
                                                    <p>{{foreach from="$ve['_data']" value="$vz"}}
				                                        <a href="{{U('List/index',array('cid'=>$vz['cid']))}}" target="_blank">{{$vz['cname']}}</a>{{endforeach}} 
				                                    </p>                            
                                                </dd>
                                            </dl> 
				...
				<ul class="nav clearfix">
					...
					{{foreach from="$oldCats" value="$va"}}
					<li>
						<a href="{{U('List/index',array('cid'=>$va['cid']))}}">{{$va['cname']}}</a>
					</li>
					{{endforeach}}
				</ul>
				<div class="nav-tips">
		...
		<div class="wrapper">
			<div class="section ztuan-section">
				...
				<div class="z-tuan-list">
					<ul class="clearfix">
						{{foreach from="$go" value="$vaa"}}
						<li>
							<a href="{{U('Content/index',array('gid'=>$vaa['gid']))}}">
								<img src="{{$vaa['listpic']}}" alt="" width="300" height="180"/>
							</a>
						</li>
						{{endforeach}}
					</ul>
			...
			<div class="section feature-section">
				...
				<div class="feature-list">
					<ul class="clearfix" id="special">
						<li class="first">
							<a href="{{U('Content/index',array('gid'=>$go[1]['gid']))}}">
								<img src="{{$go[1]['listpic']}}" alt="" height="372" width="200"/>
							</a>
						</li>
						<li>
							<a href="{{U('Content/index',array('gid'=>$first[1]['gid']))}}">
								<img src="{{$first[1]['listpic']}}" alt="" height="218" width="370" alt="" />
							</a>
						</li>
						{{foreach from="$fifth" value="$vee"}}
						<li>
							<a href="{{U('Content/index',array('gid'=>$vee['gid']))}}">
								<img src="{{$vee['listpic']}}" alt="" height="218" width="208" alt="" />
							</a>
						</li>
						{{endforeach}}
						<li>
							<a href="{{U('Content/index',array('gid'=>$second[1]['gid']))}}">
								<img src="{{$second[1]['listpic']}}" alt="" height="151" width="370" alt="" />
							</a>
						</li>
						{{foreach from="$fourth" value="$vef"}}
						<li>
							<a href="{{U('Content/index',array('gid'=>$vef['gid']))}}">
								<img src="{{$vef['listpic']}}" alt="" height="151" width="208" alt="" />
							</a>
						</li>
						{{endforeach}}
					</ul>
			...
			<div class="section mobile-section">
				...
				<div class="clearfix">
					<div class=" main-figure">
						<a href="{{U('Content/index',array('gid'=>$new[0]['gid']))}}">
							<img src="{{$new[0]['listpic']}}" alt="" height="420" width="360"/>
						</a>
					</div>
					<ul class="figure-list clearfix">
						<li class="item wide box1">
							...
							<div class="all1">
								{{foreach from="$new" value="$vabf"}}
								<a href="{{U('Content/index',array('gid'=>$vabf['gid']))}}">
								<img src="{{$vabf['listpic']}}" alt="" height="209" width="419"/>
							{{endforeach}}	</a>
							</div>
							<div class="ul1">
								<div></div>
						...
						{{foreach from="$new" value="$vab"}}
						<li class="item tall move">
							<div class="title outside">
								<a href="{{U('Content/index',array('gid'=>$vab['gid']))}}">{{$vab['gname']}}</a>
							</div>
							<a class="pic" href="{{U('Content/index',array('gid'=>$vab['gid']))}}">
								<img class="picture"src="{{$vab['listpic']}}" alt="" height="120" width="160"/>
							</a>
						</li>
						{{endforeach}}
					</ul>
				...
				<ul class="brands-list clearfix">
					{{foreach from="$brand" value="$vabc"}}
					<li>
						<a href="{{U('List/index',array('bid'=>$vabc['bid']))}}">
							<img src="{{$vabc['logo']}}" alt="" height="60" width="118"/>
						</a>
					</li>
					{{endforeach}}
				</ul>
			...
			<div class="section mobile-section">
				...
				<div class="clearfix">
					<div class=" main-figure">
						<a href="{{U('Content/index',array('gid'=>$first[0]['gid']))}}">
							<img src="{{$first[0]['listpic']}}" alt="" height="420" width="360"/>
						</a>
					</div>
					<ul class="figure-list clearfix">
							<li class="item wide box1">
							...
							<button class="bt" id="bt2">></button>
							<div class="all1">
								{{foreach from="$first" value="$vabg"}}
								<a href="{{U('Content/index',array('gid'=>$vabg['gid']))}}">
								<img src="{{$vabg['listpic']}}" alt="" height="209" width="419"/></a>
								{{endforeach}}
							</div>
							<div class="ul1">
								<div></div>
						...
						{{foreach from="$first" value="$vabh"}}
						<li class="item tall move">
							<div class="title outside">
								<a href="">{{$vabh['gname']}}</a>
							</div>
							<a class="pic" href="{{U('Content/index',array('gid'=>$vabh['gid']))}}">
								<img class="picture"src="{{$vabh['listpic']}}" alt="" height="120" width="160"/>
							</a>
						</li>
						{{endforeach}}
					</ul>
				...
				<ul class="brands-list clearfix">
					{{foreach from="$brand" value="$vabd"}}
					<li>
						<a href="{{U('List/index',array('bid'=>$vabd['bid']))}}">
							<img src="{{$vabd['logo']}}" alt="" height="60" width="118"/>
						</a>
					</li>
					{{endforeach}}
				</ul>
			...
			<div class="section mobile-section">
				...
				<div class="clearfix">
					<div class=" main-figure">
						<a href="{{U('Content/index',array('gid'=>$second[0]['gid']))}}">
							<img src="{{$second[0]['listpic']}}" alt="" height="420" width="360"/>
						</a>
					</div>
					<ul class="figure-list clearfix">
							<li class="item wide box1">
							...
							<button class="bt" id="bt2">></button>
							<div class="all1">
								{{foreach from="$second" value="$vbb"}}
								<a href="{{U('Content/index',array('gid'=>$vbb['gid']))}}">
								<img src="{{$vbb['listpic']}}" alt="" height="209" width="419"/></a>
								{{endforeach}}
							</div>
							<div class="ul1">
								<div></div>
						...
						{{foreach from="$second" value="$vbc"}}
						<li class="item tall move">
							<div class="title outside">
								<a href="">{{$vbc['gname']}}</a>
							</div>
							<a class="pic" href="{{U('Content/index',array('gid'=>$vbc['gid']))}}">
								<img class="picture"src="{{$vbc['listpic']}}" alt="" height="120" width="160"/>
							</a>
						</li>
						{{endforeach}}
					</ul>
				...
				<ul class="brands-list clearfix">
					{{foreach from="$brand" value="$vabe"}}
					<li>
						<a href="{{U('List/index',array('bid'=>$vabe['bid']))}}">
							<img src="{{$vabe['logo']}}" alt="" height="60" width="118"/>
						</a>
					</li>
					{{endforeach}}
				</ul>
			...
			<div class="section mobile-section">
				...
				<div class="clearfix">
					<div class=" main-figure">
						<a href="{{U('Content/index',array('gid'=>$third[0]['gid']))}}">
							<img src="{{$third[0]['listpic']}}" alt="" height="420" width="360"/>
						</a>
					</div>
					<ul class="figure-list clearfix">
							<li class="item wide box1">
							...
							<button class="bt" id="bt2">></button>
							<div class="all1">
								{{foreach from="$third" value="$vcc"}}
								<a href="{{U('Content/index',array('gid'=>$vcc['gid']))}}">
								<img src="{{$vcc['listpic']}}" alt="" height="209" width="419"/></a>
								{{endforeach}}
							</div>
							<div class="ul1">
								<div></div>
						...
						{{foreach from="$third" value="$vcd"}}
						<li class="item tall move">
							<div class="title outside">
								<a href="{{U('Content/index',array('gid'=>$vcd['gid']))}}">{{$vcd['gname']}}</a>
							</div>
							<a class="pic" href="{{U('Content/index',array('gid'=>$vcd['gid']))}}">
								<img class="picture"src="{{$vcd['listpic']}}" alt="" height="120" width="160"/>
							</a>
						</li>
						{{endforeach}}
					</ul>
				...
				<ul class="brands-list clearfix">
					{{foreach from="$brand" value="$vabf"}}
					<li>
						<a href="{{U('List/index',array('bid'=>$vabf['bid']))}}">
							<img src="{{$vabf['logo']}}" alt="" height="60" width="118"/>
						</a>
					</li>
					{{endforeach}}
				</ul>
