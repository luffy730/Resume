	...
	<body>
		...
		<!--register-wrap 主体区域开始-->
			<div id="register-wrap">
				...
				<form onsubmit="return hd_submit(this,'{{U('Reg/reg')}}','{{U('Login/index')}}')" id="J_RegisterForm">
					...
					<div id="J_register_phone" class="register-phone-number">
						...
						<div class="register-form">
							...
							<div class="email-captcha clearfix">
		                        ...
		                        <span class="captcha-img"><img src="{{U('Reg/code')}}" alt="" id="J_Captcha-Img_phone" height="38" width="98"></span>
