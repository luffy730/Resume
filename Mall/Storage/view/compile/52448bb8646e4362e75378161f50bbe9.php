		...
		<div class="zc-topbar" id="headEr">    
			<div class="wrapper clearfix">        
				...
				<ul class="zc-quick-menu">            
					...
					<li>
						<a href="<?php echo U('Cart/index')?>" id="shop-cart-num">购物车0件</a>
					</li>            
					<li>
						<a href="">帮助中心</a></li>            
			...
			<div class="payment-box">
				...
				<div class="order-status-box">
					<div class="submit-complete clearfix">
						...
						<div class="details">
							<p> 
								<span class="ddh"  orid="<?php echo $v['orid']?>" orderStatus="<?php echo $v['orderStatus']?>">
									您的订单号：<?php echo $v['orderNumber']?></span>  <span class="label">商品名称：<?php echo $v['goods_gname']?>等
									</span>
							</p>
								
							<p>
								<span>
									收货人：<?php echo $v['consignee']?>
								</span>
								<span>
									15830112607
								</span> 
								<span class="label">
									收货地址：<?php echo $re[0]['FullAddress']?>
								</span>
							</p>
						...
						<div class="amount-code">
							...
							<div class="price">应付金额
								<span><?php echo $v['goods_totalprice']?> 
								</span>元
							</div>
						</div>
					</div>
					...
					<dl class="third-party payment-selected" id="alipaySpanDiv">
							...
							<dd class="clearfix">
								...
								<span id="pay_amount_span" class="pay-amount">
									支付
									<em><?php echo $v['goods_totalprice']?></em>元
								</span>
								</div>
							</dd>
						</dl>
