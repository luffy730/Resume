...
<html>
	...
	<body>
		...
		<div class="form-group">
			...
			<input name="bname"  class="form-control" placeholder="请输入标签按照|分开" value="<?php echo $oldData['bname']?>">
		</div>
		<div class="form-group">
			...
			<img src="<?php echo $oldData['logo']?>" style="width:80px;height: 40px;" id="img"/>
		...
		<div class="form-group">
			...
			<input type="checkbox" value="1" name="is_hot" <?php if($oldData['is_hot']){?>
                checked
               <?php }?>/>
		</div>
