			...
			<ul class="left-bar shadow">
				...
				<li class="item-name">
					...
					<ul class="item-branch">
						...
						<li>
							<a href="<?php echo U('MyOrder/selfcenter')?>">ZOL个人中心</a>
						</li>
					</ul>
				</li>
				<li class="item-name">
			...
			<div class="right-content shadow">
				<div class="addr-section">
					...
					<div class="addr-item clearfix">
						...
						<div class="form-part">
							<input type="text" name="" class="receiver" value="" rid="<?php echo $add[0]['rid']?>" />
					...
					<table class="table-block addr-table">
                                <tbody>
                                    <tr>
                                        ...
                                        <?php foreach ($add as $va){?>							
                                    </tr>
                                    <tr class="address" rid="<?php echo $va['rid']?>">
                                        <td class="cell1 name"><?php echo $va['consignee']?></td>
                                        <td provinceid="2" cityid="494" class="one"><?php echo $va['province']?>&nbsp;&nbsp;<?php echo $va['city']?></td>
                                        <td class="address-detail"><?php echo $va['FullAddress']?></td>
                                        <td></td>
                                        <td>
                                                                                        <p fn="mobile" class="tel"><?php echo $va['rphone']?></p>                                        </td>
