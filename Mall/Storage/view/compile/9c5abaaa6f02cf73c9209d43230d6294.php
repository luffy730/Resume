		...
		<!--topbar开始-->
			...
			<div class="wrapper clearfix">
				<div class="zc-login-info">
					...
					<a href="<?php echo U('List/out')?>" class="login_act">退出</a>
					<?php else: ?>
					<span class="zc-login">
						Hi~欢迎来到ZOL商城，请
				...
				<ul class="zc-quick-menu">
					<li>
						<a href="<?php echo U('MyOrder/index')?>">
							我的订单
						</a>
					</li>
					<li class="zc-my-center">
						<a href="<?php echo U('MyOrder/center')?>">
							买家中心
						</a>
		...
		<!--分类输出区域-->
            ...
            <div class="selector here">
                <div class="selectebox">                    
                    <div class="prop-item">
                    	<?php foreach ($attr as $k=>$vaa){?>
                        <dl> 
                            <dt><?php echo $vaa['name']?>：</dt>                        
                            <dd style="height:auto;">
                                <ul class="clearfix">
                                	...
                                	<?php foreach ($vaa['value'] as $vbb){?>
                                		<?php 
                                			$temp[$k]=$vbb['gpid'];
                                		 ?>
                                    <li>
                                    	<a href="<?php echo U('List/index',array('cid'=>$_GET['cid'],'param'=>implode('_',$temp)))?>" <?php if($param[$k] ==$vbb['gpid']): ?> class="hover" <?php endif ?> title="笔记本电脑"><?php echo $vbb['gpvalue']?></a></li>
                                    <?php }?>
                                </ul>
                            </dd>
                        </dl>
		...
		<!--分类输出区域-->
            ...
            <div class="wrapper no_result_list" style="display: none; margin-top: 10px;">
                    ...
                    <ul class="goods-list clearfix" id="goodsPicList" >
           			 <?php foreach ($saleData as $vddd){?>
                        <li class="" style="float: left; width: 200px;">
                                <div class="attention" >
                                	<span>关注</span>
                                </div>                                    
                                <a href="<?php echo U('Content/index',array('gid'=>$vddd['gid']))?>" target="_blank" class="pic">
                                	<span class="img">
                                		<img src="<?php echo $vddd['listpic']?>" alt="" title="" width="200">
                                	</span>
                                </a>
                                <div class="title">
                                    <a href="<?php echo U('Content/index',array('gid'=>$vddd['gid']))?>" target="_blank">
                                        <span class="label">[限时促销]</span> 
                                           <?php echo $vddd['gname']?>
                                    </a>
                                </div>    
                                <div class="price-bar clearfix">
                                    <span class="price"><?php echo $vddd['mprice']?></span>
                                    <span class="activity-infor" style="display:none;">最多减¥1000</span>
                                </div>                                   
                                <div class="volume">
                                	<span>
                                		销量数
                                		<em>&nbsp;<?php echo $vddd['gid']?></em>
                                	</span>
                                	<span class="evaluation">
                                		评价数 
                                		<a href=""><?php echo $vddd['click']?></a>
                                	</span>
                                </div>					                             
			...
			<ul id="goodsPicList" class="goods-list clearfix" >
				<?php foreach ($goodsData as $value){?>
				<li class="data" goodsData="$value['gname']">
					<input type="hidden" name="gid" value="$value['gid']" class="gidhide" />
					<div class="attention">
						<span>关注</span>
					</div>
					<a href="<?php echo U('Content/index',array('gid'=>$value['gid']))?>"   class="pic">
						<span class="img">
							<img src="<?php echo $value['listpic']?>" alt="" title="" width="200">
						</span>
					</a>
					<div class="title">
                        <a href=""  ><?php echo $value['gname']?>
                        </a>
                    </div>
                    <div class="price-bar clearfix">
                        <span class="price"><?php echo $value['mprice']?></span>
                        <span class="activity-infor" style="display:none;">最多减¥1000</span>
                    </div>
                    <div class="volume">
                    	<span>
                    		销量数
                    		<em>&nbsp;<?php echo $value['stock']?></em>
                    	</span>
                    	<span class="evaluation">
                    		评价数 
                    		<a href=""  ><?php echo $value['click']?></a>
                    	</span>
                    </div>
