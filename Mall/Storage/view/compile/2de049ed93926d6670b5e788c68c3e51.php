...
<meta name="description" content="购物车 查看购物车"/>
	...
	<body>
		...
		<div class="zc-topbar" id="headEr">    
			<div class="wrapper clearfix">        
				<div class="zc-login-info">           
					...
					<a href="<?php echo U('Cart/out')?>" class="login_act">退出</a>                    
				</div>        
				<ul class="zc-quick-menu">            
					...
					<li>
						<a href="" id="shop-cart-num">购物车<?php echo $_SESSION['cart']['total_rows']?>件</a>
					</li>            
					<li>
						<a href="">帮助中心</a></li>            
		...
		<div class="wrapper" id="content"> 
			<form class="form" action="<?php echo U('Order/plus')?>" method="post">
				<?php if(count($_SESSION['cart']['goods'])!=0) :?> 
		        <div class="cart-state mt">	
					<p>购物车状态
					<em>（<?php echo $new?>/30）</em>
					</p>
					<div class="total">
						<input name="submitCart" type="submit"  value="去结算">
						<span>总计（不含运费）：
						<em>¥</em>
						<em class="total-cart-price" name="priceAggregate"><?php echo $to?></em>
						</span>
					</div>
				</div>
				<div class="order-table mt20">
					<table width="100%">
			            ...
			            <tr>
			                ...
			                <tr rel="goods-order" id="cart_2452190" class="item tr-<?php echo $k?>">
							<td colspan="2" class="s-infor">
			                <input name="cartId[]" type="checkbox" value="<?php echo $k?>" item="item" rel="foritem" merchantid="189882" checked="" sid="<?php echo $k?>" class="checkit">
			                <a href="" class="pic" target="_blank">
			                	<img width="80" height="60" src="<?php echo $v['list']?>" alt="" name="listpic"></a>
							<div class="inforbox">
								<h3 class="tit">
									<a href="" title="" target="_blank" sid="<?php echo $k?>" class="info" name="gname">
										<?php echo $v['name']?>
									</a>
								</h3>
...
//								sp($a);
			                 ?>
			                 <?php foreach ($a as $vi){?>
							<p><?php echo $vi['pname']?>：<?php echo $vi['gpvalue']?></p>
							...
							<td class="s-price ">                                    
			                   <em name="price"><?php echo $v['price']?></em>
							</td>
							<td class="s-amount ">
								<div class="buy-num">   
			                       <a class="minus" href="javascript:void(0)" title="减一" >-</a>
									<input type="text" autocomplete="off" class="text-amount" value="<?php echo $v['num']?>" id="cartNumber_2452190">
							...
							<td class="s-total" price="<?php echo $v['price']?>">
			                   <em><?php echo $v['total']?></em>
							</td>
							<td class="s-del">
								<div class="s-delbox"> 
									<a href="<?php echo U('Cart/delOne',array('gid'=>$k))?>" >删除</a>
					...
					<div class="total-price">
						...
						<span>（不含运费）</span>：
						<em>¥</em>
						<em class="total-cart-price"><?php echo $to?></em>
					</div>
					<div class="order-foot clearfix">
						...
						<a href="<?php echo U('Cart/del')?>" >批量删除</a>
			                        			
						<a href="" class="go-shopping">&lt;&lt;继续购物</a>
						<a type="submit"  name="submitCart" class="accounting-btn" href="<?php echo U('Order/index')?>">去结算</a>			
					</div>		
				</div>
				<?php else: ?>
				<dl class="shopcar-tip" >
					<dt>您的购物车里还没有商品，您可以：</dt>		
					<dd>去<a href="<?php echo U('Index/index')?>">挑选商品</a></dd>
				</dl>    
			...
			<div class="modgoods mt20">
				...
				<div class="modgoods-tabbox">
					<ul class="modgoods-list clearfix guess">
						<?php foreach ($data as $vc){?>
					<li>
						<a class="pic" href="<?php echo U('Content/index',array('gid'=>$vc['gid']))?>" title="" target="_blank">
							<img width="160" height="120" src="<?php echo $vc['listpic']?>" alt="">
								<span><?php echo $vc['gname']?></span>
							</a>
						<div class="price"><?php echo $vc['mprice']?></div>
					</li>
					<?php }?>
					</ul>			
				</div>
