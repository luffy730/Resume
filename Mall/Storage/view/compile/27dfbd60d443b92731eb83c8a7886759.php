...
<html>
			...
			<div class="wrapper clearfix">        
				<div class="zc-login-info">           
					...
					<span class="zc-login" title="qq_482s79c1638u">
						您好，
						<a href="" target="_blank"><?php echo $_SESSION['nickname']?></a>
					</span>                
					<a href="<?php echo U('Cart/out')?>" class="">退出</a>                    
				</div>        
				<ul class="zc-quick-menu">            
					...
					<li class="zc-my-center" onmouseover="showUI(this)" onmouseout="hideUI(this)">                
						<a href="<?php echo U('MyOrder/center')?>" class="zc-hd">买家中心
							<i class="ico"></i>
						</a>                
					...
					<li>
						<a href="<?php echo U('Cart/index')?>" id="shop-cart-num">购物车<?php echo $_SESSION['cart']['total_rows']?>件</a>
					</li>            
					<li>
						<a href="">帮助中心</a></li>            
                    ...
                    <td class="cell-2">
                        <ul class="address-list">
                        		<?php 
                                        ...
                                        <?php foreach ($addData as $va){?>
                            <li class="current delete address-<?php echo $va['rid']?>" id="list_733038" addliid="<?php echo $va['rid']?>">
                                    <label>
                                        <span>
                                    	<input autocomplete="off" id="addressId_733038"  name="address" rid="<?php echo $va['rid']?>" type="radio" value="733038" class="address">
                                        	...
                                        	<strong>
                                        		[默认] 
                                        		<em class="namer"><?php echo $va['consignee']?></em>
                                        		<strong class="address"><?php echo $va['FullAddress']?> <?php echo $va['rphone']?></strong>
                            ...
                            <li class="add-edits">
                                <label>
                                    ...
                                    <dl>
                                        ...
                                        <!--订单号的隐藏域-->
                                        <input type="hidden" name="order_orid" value="<?php echo $list[0]['order_orid']?>" class="orId"/>
                                    </dl>
                                    <dl class="addarea">
                                        <dt>
                                        <em class="xh">*</em>
							...
							<input type="hidden" name="client_clid" value="<?php echo $_SESSION['clid']?>" />
    ...
    <!-- //收货人信息 -->
		<form action="<?php echo U('Order/edit')?>" method="post" id="first">
            <!-- 购物车商品信息 -->
                                        ...
                                        <th class="total">总价</th>
                                            ...
                                            <td class="infor">
                                                <a href="" target="_blank" class="pic">
                                                	<img src="<?php echo $v['goods_listpic']?>" alt="" height="60" width="60"></a>
                                                <h3 class="title">
                                                	<a href="" target="_blank">
                                                		<?php echo $v['goods_gname']?>
                                                	</a>
                                                </h3>
                                            </td>
                                           <?php 
                                            ...
                                            <td class="color-suits">
                                            	<?php if($newData): ?>
                                            	<?php foreach ($newData as $va){?>
                                                <div class="color"><?php echo $va?></div>
                                                <?php }?>
                                                <?php endif ?>
                                                </div>
                                            </td>
                                            ...
                                            <td class="price">¥<?php echo $v['goods_price']?></td>
                                            <td>--</td>
                                            <td class="amount"><?php echo $v['amount']?></td>
                                            <td class="total">¥<?php echo $v['subtotalPrice']?></td>
                                        </tr>
                                     </tbody>
                                </table>
	...
	<!-- 订单备注 -->
		<div class="order-note">
				...
				<tbody>
					...
					<td class="cell-3">
						<ul class="total-price">
							<li><span>商品总价：</span><em id="goods-total-price">¥<?php echo $v['goods_totalprice']?></em></li>
							<li><span>运费：</span><em id="goods-freight-price">¥-</em></li>
							<li><span>订单总计：</span><em class="total" id="total-price" >¥<?php echo $v['goods_totalprice']?></em></li>
						</ul>
					</td>
				</tr>
			</tbody></table>
			...
			<div class="submit-order clearfix">
                <a href="<?php echo U('Cart/index')?>" class="submit-return">返回修改购物车</a>
                <input type="hidden" name="goods_totalprice" value="<?php echo $list[0]['goods_totalprice']?>" />
                <input type="hidden" name="orid" value="<?php echo $list[0]['order_orid']?>" />
                <input type="hidden" name="rid"  value="<?php echo $rData[0]['rid']?>" class="order"/>
